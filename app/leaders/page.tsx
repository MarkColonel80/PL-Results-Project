...
export default function Leaders(){
 const[season,setSeason]=useState("2026/27"),[rows,setRows]=useState<any[]>([]),[query,setQuery]=useState(""),[sort,setSort]=useState("contributions");
