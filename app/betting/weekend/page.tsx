...
export default function WeekendVenueReview(){
 ...
 return <>
  ...
  <div style={{display:"grid",gap:14}}>{cards.map(({f,s,m,calc})=><section className="card" key={f.fixture_id}>
   ...
   {!s?<p>No snapshot.</p>:<>
    <div style={{marginTop:12}}><b>Calculation inputs</b><div className="muted" style={{marginTop:4}}>These figures are used by the current weekend calculation.</div></div>
